    ...
    for i in range(len(board)):
        for j in range(len(board)):
            ...
            if j + 4 < len(board):
                ...
                if (temp_1 == ["b"] * 5):
                    return 1, "horizontal"       #REMOVE THE STRING WHEN FIXED
                if (temp_1 == ["w"] * 5):
                    return 0, "horizontal"        #REMOVE THE STRING WHEN FIXED
            ...
            if i + 4 < len(board):
                ...
                if (temp_2 == ["b"] * 5):
                    return 1, "vertical"          #REMOVE THE STRING WHEN FIXED
                if (temp_2 == ["w"] * 5):
                    return 0, "vertical"           #REMOVE THE STRING WHEN FIXED
            ...
            if i + 4 < len(board) and j + 4 < len(board):
                ...
                if (temp == ["b"] * 5):
                    return 1, "diagonal1"            #REMOVE THE STRING WHEN FIXED
                if (temp == ["w"] * 5):
                    return 0, "diagonal1"           #REMOVE THE STRING WHEN FIXED
            ...
            if i + 4 < len(board) and j - 4 < len(board):
                ...
                if (temp_3 == ["b"] * 5):
                    return 1, "diagonal2"           #REMOVE THE STRING WHEN FIXED
                if (temp_3 == ["w"] * 5):
                    return 0, "diagonal2"           #REMOVE THE STRING WHEN FIXED
    
    if draw:
        return 2, "this is fine"                #REMOVE THE STRING WHEN FIXED
    return 3, "this is fine"                         #REMOVE THE STRING WHEN FIXED


def is_win(board):
    states = ["White won", "Black won", "Draw", "Continue Playing"]
    return states[iswin(board)[0]], iswin(board)[1]                        #CHANGE THIS BACK TO states[iswin(board)]
...
def test_gomoku(n):
    for d in range(n):
        ...
        print ("is_win test: " + str(is_win(new_board)))                             #REMOVE THIS STR WHEN ITS FIXED
        for f in range(7):
            print(" ")
test_gomoku(20)              