...
def self_play(model, games=128, game_iter=225, search_iter=512, gamma=1):
    ...
    Args:
        ...
        game_iter (int, optional): The maximum length of the games. Defaults to 225.
    ...
    """
    boards = np.zeros((games, 15, 15, 2,), dtype="float32")
    players = [1]*games
    inputs = None
...
def ai_v_ai(black, white, games=64, game_iter=225, search_iter=512, tau=0):
